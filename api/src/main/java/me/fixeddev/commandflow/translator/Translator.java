...
/**
 * An interface that allows to convert a {@link net.kyori.adventure.text.TranslatableComponent} into a
 * {@link net.kyori.adventure.text.TextComponent}.
 */
public interface Translator {

    /**
     * Translates the given {@link Component} if it is a {@link net.kyori.adventure.text.TranslatableComponent}
     ...
     * @return The translated {@link net.kyori.adventure.text.TextComponent} or the same instance if it isn't a {@link net.kyori.adventure.text.TranslatableComponent}
     */
