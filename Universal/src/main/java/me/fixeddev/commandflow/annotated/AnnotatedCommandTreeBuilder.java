...
public interface AnnotatedCommandTreeBuilder {
     ...
     * <p>
     * @see me.fixeddev.commandflow.annotated.annotation.Command It is used to indicate whether a method or a class is a Command,
     ...
     * @see me.fixeddev.commandflow.annotated.annotation.Handler It is used to indicate that a method of a class with subcommands is the one that
     ...
     * an annotated method.
     * @see me.fixeddev.commandflow.annotated.annotation.SubCommandClasses This annotation is used to indicate that the given classes are actually subcommands
