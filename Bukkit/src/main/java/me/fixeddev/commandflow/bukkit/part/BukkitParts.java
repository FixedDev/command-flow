...
public final class BukkitParts {
     ...
     * @return A {@link me.fixeddev.commandflow.part.CommandPart} with a given name that returns the {@link org.bukkit.command.CommandSender} as argument.
     */
    ...
    /**
     * A basic {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string from the {@link me.fixeddev.commandflow.stack.ArgumentStack} and parses it into
    ...
    /**
     * A {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string from the {@link me.fixeddev.commandflow.stack.ArgumentStack}
    ...
    /**
     * A basic {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string as nick or uuid from the {@link me.fixeddev.commandflow.stack.ArgumentStack} and parses it into
    ...
    /**
     * A basic {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string as nick from the {@link me.fixeddev.commandflow.stack.ArgumentStack} and parses it into
    ...
    /**
     * A {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string as nick or as uuid from the {@link me.fixeddev.commandflow.stack.ArgumentStack}
    ...
    /**
     * A {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string as nick or as uuid (if exact mode is not enabled)
     * from the {@link me.fixeddev.commandflow.stack.ArgumentStack} and tries to parse it into an {@link org.bukkit.entity.Player}.
     *
     * @param name The name for this part.
    ...
    /**
     * A {@link me.fixeddev.commandflow.part.CommandPart} that tries parsing the CommandSender as a {@link org.bukkit.entity.Player}.
     *
     * @param name The name for this part.
    ...
    /**
     * A {@link me.fixeddev.commandflow.part.ArgumentPart} that takes a string as world name and tries to parse it into a
